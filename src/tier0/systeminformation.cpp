...
SYSTEM_CALL_RESULT_t Plat_GetPagedPoolInfo( PAGED_POOL_INFO_t *pPPI )
{
	...
	static _TCHAR szModule1[] = _T( "ntdll.dll" );
	static char szFunction1[] = "NtQuerySystemInformation";
	static CSysCallCacheEntry_FindModule qsi( szModule1, szFunction1 );
...
#define MAKEVER( high, low ) DWORD( MAKELONG( low, high ) )
		...
		_TCHAR szModule2[] = _T( "kernel32.dll" );
		char szFunction2[] = "IsWow64Process";
		CSysCallCacheEntry_FindModule wow64( szModule2, szFunction2 );
